...
addEvent(searchTogglers, 'click', toggleSearch);
...
export const updateWeather = (lat, lon) => {
  ...
  // container.classList.contains('fade-in') ?? container.classList.remove('fade-in'); // check 2:25:39 //
      ...
      for (const [index, data] of forecastList.entries()) {
        ...
        windLi.innerHTML = `
            <div class="card card-sm slider-card">
                <p class="body-3">${module.getHours(dateTimeUnix, timezone)}</p>
                <img
                    src="../../src/assets/images/weather_icons/direction.png"
                    alt="direction"
                    class="weather-icon"
                    width="48"
                    height="48"
